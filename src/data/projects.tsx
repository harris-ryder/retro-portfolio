    ...
    content: (
      <>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '3.5rem', marginBottom: '3.5rem' }}>
          ...
          <img src="/images/nothing-ai-builder/widgets.webp" alt="Windows 98 themed widgets on device" style={{ ...videoStyle, marginTop: 0, marginBottom: 0, flex: 1, minWidth: 0, objectFit: 'cover' }} />
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p><img src="/images/paintball/paintball1.webp" alt="Paint ball Project" /></p>
        <p><img src="/images/paintball/paintball3.webp" alt="Paint ball Project" /></p>
        <p><img src="/images/paintball/paintball2.webp" alt="Paint ball Project" /></p>
        ...
        <p><img src="/images/paintball/paintball4.webp" alt="Paint ball Project" /></p>
        ...
        <h2>Actual Design</h2>
        <p><img src="/images/paintball/paintball5.webp" alt="Paint ball Project" /></p>
        <p><img src="/images/paintball/paintball6.webp" alt="Paint ball Project" /></p>
        <p><img src="/images/paintball/paintball7.webp" alt="Paint ball Project" /></p>
        <h2>Software</h2>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Concept</h2>
        <p><img src="/images/infinityring/infinityring1.webp" alt="Infinity Ring Project" /></p>
        ...
        <h2>Design</h2>
        <p><img src="/images/infinityring/infinityring3.webp" alt="Infinity Ring Project" /></p>
        <p>The product offering includes two rings, two straps with buckles and a door/tree anchor.</p>
        <p><img src="/images/infinityring/infinityring2.webp" alt="Infinity Ring Project" /></p>
        <p><img src="/images/infinityring/infinityring4.webp" alt="Infinity Ring Project" /></p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Buying a van</h2>
        <p><img src="/images/van/van1.webp" alt="Campervan project" /></p>
        ...
        <h2>Clean up</h2>
        <p><img src="/images/van/van6.webp" alt="Campervan project" /></p>
        <p>The first step was to strip all the wooden panelling and treat any surface rust.</p>
        <h2>Design</h2>
        <p><img src="/images/van/van2.webp" alt="Campervan project" /></p>
        ...
        <h2>Building</h2>
        <p><img src="/images/van/van4.webp" alt="Campervan project" /></p>
        <p>Adding the wall panels was the most time consuming step. It takes multiple cuts to make them fit right.</p>
        <p><img src="/images/van/van9.webp" alt="Campervan project" /></p>
        <p><img src="/images/van/van10.webp" alt="Campervan project" /></p>
        <p><img src="/images/van/van3.webp" alt="Campervan project" /></p>
        <h2>Finished Product</h2>
        <p><img src="/images/van/van7.webp" alt="Campervan project" /></p>
        <p><img src="/images/van/van11.webp" alt="Campervan project" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Design</h2>
        <p><img src="/images/doge/doge2moon.webp" alt="Doge Rocket App" /></p>
        <p><img src="/images/doge/doge2moon2.webp" alt="Doge Rocket App" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Design</h2>
        <p><img src="/images/masks/masks3.webp" alt="NHS Masks Project" /></p>
        ...
        <p><img src="/images/masks/masks2.webp" alt="NHS Masks Project" /></p>
        ...
        <p><img src="/images/masks/masks5.webp" alt="NHS Masks Project" /></p>
        <p>We produced over 2000 masks, we sold 1500 to the NHS and donated 500+ to care homes.</p>
        <p><img src="/images/masks/masks4.webp" alt="NHS Masks Project" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Renders</h2>
        <p><img src="/images/centrifuge/render2.webp" alt="Centrifuge Design Project" /></p>
        <p><img src="/images/centrifuge/render1.webp" alt="Centrifuge Design Project" /></p>
        <h2>Design Process</h2>
        <p><img src="/images/centrifuge/centrifugeImage.webp" alt="Centrifuge Design Project" /></p>
        <h2>Prototypes</h2>
        <p><img src="/images/centrifuge/proto3.webp" alt="Centrifuge Design" /></p>
        <p><img src="/images/centrifuge/proto4.webp" alt="Centrifuge Design" /></p>
        <p><img src="/images/centrifuge/proto5.webp" alt="Centrifuge Design" /></p>
        <p><img src="/images/centrifuge/centrifugeImage2.webp" alt="Centrifuge Design" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Prototypes</h2>
        <p><img src="/images/muracle/prototype1.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/prototype2.webp" alt="Muracle Design Project" /></p>
        <h2>Design Process</h2>
        <p><img src="/images/muracle/MPDesignProject.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject2.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject3.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject4.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject5.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject6.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject7.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject8.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject9.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject10.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject11.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject12.webp" alt="Muracle Design Project" /></p>
        <p><img src="/images/muracle/MPDesignProject13.webp" alt="Muracle Design Project" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h2>Design</h2>
        <p><img src="/images/panlImage1.webp" alt="Panl App" /></p>
        <p><img src="/images/panlImage2.webp" alt="Panl App" /></p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p><img src="/images/vacuumPage1.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage2.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage3.webp" alt="Vacuum Design Project" /></p>
        <h2>Brand Selection</h2>
        <p><img src="/images/vacuumPage4.webp" alt="Vacuum Design Project" /></p>
        <h2>Early Concept Design</h2>
        <p><img src="/images/vacuumPage5.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage6.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage7.webp" alt="Vacuum Design Project" /></p>
        <h2>Design Development</h2>
        <p><img src="/images/vacuumPage8.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage9.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage10.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage11.webp" alt="Vacuum Design Project" /></p>
        <h2>Final Design</h2>
        <p><img src="/images/vacuumPage12.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage13.webp" alt="Vacuum Design Project" /></p>
        <p><img src="/images/vacuumPage14.webp" alt="Vacuum Design Project" /></p>
      </>
    ),
  },
]
