  ...
  return (
    <main className="min-h-screen px-6 py-16 text-[15px] leading-[1.7] text-neutral-400">
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="article-content [&_p]:my-6 [&_h2]:mt-14 [&_h2]:mb-4 [&_h2]:font-normal [&_h2]:text-[15px] [&_h2]:text-neutral-800 [&_h2]:subpixel-antialiased [&_ol]:my-6 [&_li]:my-1 [&_a]:underline">
          {project.content}
        </div>
      </div>
    </main>
